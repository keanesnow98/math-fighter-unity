...
{
    /// <summary>
    /// LIVE multiplayer version of the Vs splash screen
    /// </summary>
    [TorqueXmlSchemaType]
    public class GameStateVsSplashMultiplayerLIVE : GameStateVsSplash
    {
        protected override void GotoGameplay()
        {
            // Play ball!!!
            GameStateManager.Instance.ClearAndLoad(GameStateNames.GAMEPLAY_MULTIPLAYER_LIVE, null);
        }
    }
}
